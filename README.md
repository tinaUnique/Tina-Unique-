...
<img src="assets/publisher-logo.png" alt="InkWorld Publishing" />
Footer code

<footer style="background-color:#0A0A0A; padding:2rem 1rem; text-align:center; position:relative;">

<!-- Soft Ink Splash Behind Footer -->
<img src="ink-splash.png" alt="Soft Ink Splash" style="position:absolute; top:-30px; left:50%; transform:translateX(-50%); width:250px; opacity:0.1; z-index:0; pointer-events:none;"/>

<!-- Social Links -->
<div style="margin-bottom:1rem; position:relative; z-index:1;">
<a href="https://instagram.com/yourprofile" target="_blank" style="margin:0 10px; color:#FF4FA8; font-weight:700; text-decoration:none;">Instagram</a>
<a href="https://facebook.com/yourprofile" target="_blank" style="margin:0 10px; color:#FF4FA8; font-weight:700; text-decoration:none;">Facebook</a>
<a href="https://linkedin.com/in/yourprofile" target="_blank" style="margin:0 10px; color:#FF4FA8; font-weight:700; text-decoration:none;">LinkedIn</a>
<a href="https://twitter.com/yourprofile" target="_blank" style="margin:0 10px; color:#FF4FA8; font-weight:700; text-decoration:none;">Twitter</a>
</div>

<!-- Newsletter Signup -->
<div style="margin-bottom:1rem; position:relative; z-index:1;">
<form action="mailto:your-email@example.com" method="post" enctype="text/plain" style="display:inline-block;">
<input type="email" name="email" placeholder="Your email" required
style="padding:0.5rem 1rem; border-radius:20px; border:none; margin-right:0.5rem; font-family:'Merriweather', serif;">
<button type="submit" style="padding:0.5rem 1.5rem; border-radius:20px; border:none; background-color:#FF4FA8; color:white; font-weight:700; font-family:'Montserrat', sans-serif; cursor:pointer;">Subscribe</button>
</form>
</div>

<!-- Publishing Logo -->
<div style="margin-bottom:1rem; position:relative; z-index:1;">
<img src="publisher-logo.png" alt="InkWorld Publishing" style="height:50px;">
</div>

<p style="color:#666; font-size:0.9rem; position:relative; z-index:1;">&copy; 2025 Tina Unique. All rights reserved.</p>
</footer>
<!DOCTYPE html>
<html lang="en">
<head>
...
<title>Contact Tina Unique</title>
<style>
